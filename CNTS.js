...
var convertor = {
    ...
    convert: function (num) {
        ...
        var dahgan1 = ['ده', 'یازده', 'دوازده', 'سیزده', 'چهارده', 'پانزده', 'شانزده', 'هفده', 'هجده', 'نوزده'];
        var dahgan2 = ['بیست', 'سی', 'چهل', 'پنجاه', 'شصت', 'هفتاد', 'هشتاد', 'نود'];
        ...
        for (var i = _num.length - 1; i >= 0; i--) {
            ...
            switch (_count) {
                ...
                case 4:
                    ...
                    if (_s >= 0) {
                        _hezargan = yekan[_s];
                        if (_yekan.trim() != '' || _dahgan.trim() != '' || _sadgan.trim() != '')
                            _hezargan += ' هزار و ';
                        else
                            _hezargan += ' هزار ';
                    }
                ...
                case 5:
                    if (_s >= 0) {
                        ...
                        if (_s == 0) {
                            ...
                            _hezargan = dahgan2[_s - 1] + ' و ' + yekan[_d - 1] + ' هزار ';
                ...
                case 7:
                    ...
                    if (_s >= 0) {
                        ...
                        if (_yekan.trim() != '' || _dahgan.trim() != '' || _sadgan.trim() != '' || _hezargan.trim() != '' || _hezargan2.trim() != '')
                            _milion += ' و '
                    ...
                    if (_s >= 0) {
                        ...
                        if (_s == 0) {
                            ...
                            if (yekan[_d - 1] == undefined)
                                ...
                                _milion = dahgan2[_s - 1] + ' و ' + yekan[_d - 1] + ' میلیون ';
                ...
                case 10:
                    ...
                    if (_s >= 0) {
                        ...
                        if (_yekan.trim() != '' || _dahgan.trim() != '' || _sadgan.trim() != ''
                            || _hezargan.trim() != '' || _hezargan2.trim() != ''
                            || _milion.trim() != '' || _milion2.trim() != ''
                            )
                            _miliard += 'و '
                    ...
                    if (_s >= 0) {
                        ...
                        if (_s == 0) {
                            ...
                            if (yekan[_d - 1] == undefined)
                                ...
                                _miliard = dahgan2[_s - 1] + ' و ' + yekan[_d - 1] + ' میلیارد ';

                        }

                        if (_yekan.trim() != '' || _dahgan.trim() != '' || _sadgan.trim() != '' || _hezargan.trim() != '' || _hezargan2.trim() != '' || _milion.trim() != '' || _milion2.trim() != '')
                            _miliard += 'و ';
                    }
                    break;
                case 12:
